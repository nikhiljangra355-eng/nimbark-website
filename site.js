    ...
    var footer = el(
      ...
      '</svg>' +
        ...
        '<div class="footer-col"><h4>Contact</h4>' +
          '<a href="tel:' + PHONE_TEL + '" class="foot-row"><span class="fr-ic fr-call">' + ICON.phone + '</span><span>Call: ' + PHONE_DISPLAY + '</span></a>' +
          ...
          '<a href="' + MAPS_URL + '" target="_blank" rel="noopener" class="foot-row"><span class="fr-ic fr-pin">' + ICON.pin + '</span><span>#1640/12, Opp. 3rd Gate Kurukshetra University, Kurukshetra, Haryana, India</span></a>' +
        '</div>' +
      '</div>' +
